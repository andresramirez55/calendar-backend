...
type NotificationController struct {
	...
	scheduler           *notificationservice.NotificationScheduler
}

func NewNotificationController(notificationService *notificationservice.NotificationService, scheduler *notificationservice.NotificationScheduler) *NotificationController {
