...
import (
	eventcontroller "calendar-backend/internal/controller/event"

	"github.com/gin-gonic/gin"
)

func SetupRoutes(router *gin.Engine, eventController *eventcontroller.EventController) {
	// API v1 group
...
func SetupMobileRoutes(router *gin.Engine, mobileHandler *eventcontroller.MobileHandler) {
	// Mobile API group
...
func SetupAllRoutes(router *gin.Engine, eventController *eventcontroller.EventController, mobileHandler *eventcontroller.MobileHandler) {
